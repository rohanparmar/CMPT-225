...
// Constructor
UnableToInsertException::UnableToInsertException(const string &message) : logic_error("newElement cannot be inserted into the data collection ADT class Exception: ") {}
